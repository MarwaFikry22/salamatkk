...
dburl= f'mysql+pymysql://{"DBUSERNAME"}: {"DBPASSWORD"} : id18976729_drug_interaction@localhost/https://databases.000webhost.com/sql.php?server=1&db=id18976729_drug_interaction'
...
def index():
    ...
    if 'username' not in userDetails or 'password' not in userDetails:
